...
export const SVG_KEYS = {
  ...
  // duplicate
  DuplicateOutlined: 'DuplicateOutlined',
  DuplicateFilled  : 'DuplicateFilled'  ,
  // receipts
  ReceiptsOutlined: 'ReceiptsOutlined',
  ReceiptsFilled  : 'ReceiptsFilled'  ,
